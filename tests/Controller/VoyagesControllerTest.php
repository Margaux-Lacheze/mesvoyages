...
class VoyagesControllerTest extends WebTestCase {
    ...
    public function testContenuPage() {
        ...
        $this->assertSelectorTextContains('h5', 'Saint-Pair-Sur-Mer');
    }
    ...
    public function testLinkVille() {
        ...
        $client->clickLink('Saint-Pair-Sur-Mer');
    ...
    public function testFiltreVille() {
        ...
        $crawler = $client->submitForm('filtrer', [
            'recherche' => 'Saint-Pair-Sur-Mer'
        ]);
        //vérifie le nombre de lignes obtenu
